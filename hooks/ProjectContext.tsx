...
export function ProjectProvider({ children }: { children: ReactNode }) {
  const projectData: Project[] = [
    ...
    },
    {
      ...
      summary: "A Kanban board created in React. The user can add or delete tasks, organize them with a category of choice, use drag-and-drop to move the tasks to other columns of the board and view specific details of each existing task.",
      desc: "Assignment, Execution, Reflection.",
      screenshots: ["/images/kanban1.png", "/images/kanban2.png", "/images/kanban3.png"],
    ...
    },
    {
      ...
      summary: "This dashboard is a customizable site for each user. The user can add and save links of their choice, write personal notes, watch the local weather forecast and view current news articles.",
      desc: "Assignment, Execution, Reflection.",
      screenshots: ["/images/Dashboard1.png", "/images/Dashboard2.png", "/images/Dashboard3.png"],
    ...
    },
    {
      ...
      desc: "Assignment, Execution, Reflection.",
      screenshots: ["/images/ScreensBACHELORTHESIS.png", "/images/bachelor_test.jpg"],
